define([
    ...
    Main.prototype = {
        ...
        create: function() {
            ...
            this.tilemap.groundLayer = map.createLayer('Ground Layer');
            this.tilemap.groundDetailLayer = map.createLayer('Ground Detail Layer');
            this.tilemap.objectLayer = map.createLayer('Object Layer');
            this.tilemap.overheadLayer = map.createLayer('Overhead Layer');
            this.tilemap.collisionLayer = map.createLayer('Collision Layer');
            ...
            map.setCollision(257, true, this.tilemap.collisionLayer);
        ...
        update: function() {
            Game.physics.arcade.collide(this.player, this.tilemap.collisionLayer);
