define(function() {
    ...
    Title.prototype = {
        create: function() {
            var titleBackground = Game.add.bitmapData(Game.world.width, Game.world.height);
            var gradient = titleBackground.context.createLinearGradient(0, 0, 0, Game.world.height);
            gradient.addColorStop(0, 'rgb(9, 20, 158)');
            gradient.addColorStop(0.6, 'rgb(106, 179, 234)');
            titleBackground.context.fillStyle = gradient;
            titleBackground.context.fillRect(0, 0, Game.world.width, Game.world.height);
